...
|------------------|-----------|
| **Windows** | [lemonade.msi](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade.msi) |
| **Ubuntu 24.04+** | [Launchpad PPA](https://launchpad.net/~lemonade-team/+archive/ubuntu/stable) |
| **Debian 13 (x86_64)** | [lemonade-server_2026.39.1-debian13_amd64.deb](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server_2026.39.1-debian13_amd64.deb) |
| **Debian 13 (ARM64)** | [lemonade-server_2026.39.1-debian13_arm64.deb](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server_2026.39.1-debian13_arm64.deb) |
| **Fedora 43 (x86_64)** | [lemonade-server-2026.39.1-fc43.x86_64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server-2026.39.1-fc43.x86_64.rpm) |
| **Fedora 43 (ARM64)** | [lemonade-server-2026.39.1-fc43.aarch64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server-2026.39.1-fc43.aarch64.rpm) |
| **Fedora 44 (x86_64)** | [lemonade-server-2026.39.1-fc44.x86_64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server-2026.39.1-fc44.x86_64.rpm) |
| **Fedora 44 (ARM64)** | [lemonade-server-2026.39.1-fc44.aarch64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server-2026.39.1-fc44.aarch64.rpm) |
| **macOS** | [Lemonade-2026.39.1-Darwin.pkg](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/Lemonade-2026.39.1-Darwin.pkg) |
...
| Platform | Download |
|----------|----------|
| **Ubuntu x64** | [lemonade-embeddable-2026.39.1-ubuntu-x64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-embeddable-2026.39.1-ubuntu-x64.tar.gz) |
| **Ubuntu arm64** | [lemonade-embeddable-2026.39.1-ubuntu-arm64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-embeddable-2026.39.1-ubuntu-arm64.tar.gz) |
| **Windows x64** | [lemonade-embeddable-2026.39.1-windows-x64.zip](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-embeddable-2026.39.1-windows-x64.zip) |
| **macOS arm64** | [lemonade-embeddable-2026.39.1-macos-arm64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-embeddable-2026.39.1-macos-arm64.tar.gz) |
...
* fix(server): streaming stall window follows global_timeout (#3386) by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3477
* ci(hrx): bump hrx + add llama-3.1 8b ci coverage by `AaronStGeorge` in https://github.com/lemonade-sdk/lemonade/pull/3503
* feat: update FLM to v1.0.4 by `zaneni6` in https://github.com/lemonade-sdk/lemonade/pull/3482
* Switch to bundler module resolution for tsconfig by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/3186
* server(mcp): revert internal mcp client code (from PR 2605) by `fl0rianr` in https://github.com/lemonade-sdk/lemonade/pull/3498
* Minor follow-up cleanup to #3330 by `SlawomirNowaczyk` in https://github.com/lemonade-sdk/lemonade/pull/3444
* fix(routing): don't drop the whole router policy over one hardware-filtered classifier by `Bekhouche` in https://github.com/lemonade-sdk/lemonade/pull/3414
* ci(vllm): keep the HF model cache outside the workspace by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3345
* update image endpoints documentation by `bitgamma` in https://github.com/lemonade-sdk/lemonade/pull/3358
* fix: name the gpt-oss-120b checkpoint instead of globbing by `noamsto` in https://github.com/lemonade-sdk/lemonade/pull/3496
* feat(server): support wildcard port and host matching in allowed origins by `abn` in https://github.com/lemonade-sdk/lemonade/pull/3470
* Remove the Linux Distro Builds ci job by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3524
* Use the selected GPU for context auto-tuning by `popey` in https://github.com/lemonade-sdk/lemonade/pull/3018
* Fix incompatible GGUF results in model search by `popey` in https://github.com/lemonade-sdk/lemonade/pull/3198
* docs: add Interviewer app integration guide by `antmikinka` in https://github.com/lemonade-sdk/lemonade/pull/1375
* feat(flm): resolve FLM model source from default_model_source by `wariobot09` in https://github.com/lemonade-sdk/lemonade/pull/2841
* fix(security): pin vendored model-viewer bundle to verified upstream by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/2709
* Fix(#3479) Added auto_evict vars to defaults.json and updated doc by `GabrielReusRodriguez` in https://github.com/lemonade-sdk/lemonade/pull/3488
* Use pkgconfig to find libdrm_amdgpu by `jamespthomas` in https://github.com/lemonade-sdk/lemonade/pull/3516
* Bump FastFlowLM (flm) NPU backend version to v1.0.5 by `zaneni6` in https://github.com/lemonade-sdk/lemonade/pull/3533
* policy: Overhaul the contribution guidelines by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3521
* feat(server): serve bundled API docs at /docs by `anditherobot` in https://github.com/lemonade-sdk/lemonade/pull/3347
* [ci][hrx-backend] Adds Backend regression testing on HRX experimental backend by `iswaryaalex` in https://github.com/lemonade-sdk/lemonade/pull/3480
* Update stable-diffusion.cpp to master-843-462d675 and CUDA master-841-017cc8e by `github-actions`[bot] in https://github.com/lemonade-sdk/lemonade/pull/3513
* [cloud][fix] Relay caller session continuity headers upstream by `SlawomirNowaczyk` in https://github.com/lemonade-sdk/lemonade/pull/3510
* ci: pin every self-hosted runs-on list to an architecture label by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3552
* Serve example HTML demos over localhost instead of opening from disk by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3547
* docs(guide): fix allowed origins rendering and structure by `abn` in https://github.com/lemonade-sdk/lemonade/pull/3538
* ci: enable tool calling testing for llamacpp and FLM  by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3550
* docs: update windows prerequisites by `sofiageo` in https://github.com/lemonade-sdk/lemonade/pull/3443
* fix(server): report backend streams that end without any SSE event by `Yigtwxx` in https://github.com/lemonade-sdk/lemonade/pull/3448
* fix(server): stop erasing llama.cpp slots on soft-idle downsize #2961 by `meghsat` in https://github.com/lemonade-sdk/lemonade/pull/3565
* implement `/images/edit` in TheNoise by `bitgamma` in https://github.com/lemonade-sdk/lemonade/pull/3494
* Release to candidate PPA not stable PPA by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/3529
* Implement new version handling scheme by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/3539
* ci: publish release branch builds as GitHub prereleases by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3579
* ci: create the weekly release branch on a schedule by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3580
* ci: publish release branch builds to the candidate Docker tag by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3581
* Adjust release.md for new release process by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/3553
* docs(website): keep release candidates out of the homepage carousel by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3588
* tools/version.py: fall back to a dated placeholder outside a git work tree by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3589
* Moved the snap release candidate trigger from the repo-manager workflow by `kenvandine` in https://github.com/lemonade-sdk/lemonade/pull/3584
* ci: run repo-manager from the workflows, with its state in lemonade-testing by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3593
* Update llama.cpp to b10825 by `github-actions`[bot] in https://github.com/lemonade-sdk/lemonade/pull/3512
* Change the release cutoff to Wednesday 16:00 UTC (and make it DRY) by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3600

</details>

## New Contributors
* `antmikinka` made their first contribution in https://github.com/lemonade-sdk/lemonade/pull/1375
* `jamespthomas` made their first contribution in https://github.com/lemonade-sdk/lemonade/pull/3516

**Full Changelog**: https://github.com/lemonade-sdk/lemonade/compare/v11.9.0...v2026.39.1
...
- `extra_models_dir` models in reserved folders (`chat/`, `embeddings/`, `reranking/`) are now listed individually per file instead of as a single `extra.<directory>` model; legacy `extra.chat`/`extra.embeddings`/`extra.reranking` IDs still resolve as hidden aliases to the first file alphabetically.
...
| Operating System | Downloads |
|------------------|-----------|
| **Windows** | [lemonade.msi](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade.msi) |
| **Ubuntu 24.04+** | [Launchpad PPA](https://launchpad.net/~lemonade-team/+archive/ubuntu/stable) |
| **Debian 13 (x86_64)** | [lemonade-server_11.9.0-debian13_amd64.deb](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server_11.9.0-debian13_amd64.deb) |
| **Debian 13 (ARM64)** | [lemonade-server_11.9.0-debian13_arm64.deb](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server_11.9.0-debian13_arm64.deb) |
| **Fedora 43 (x86_64)** | [lemonade-server-11.9.0-fc43.x86_64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server-11.9.0-fc43.x86_64.rpm) |
| **Fedora 43 (ARM64)** | [lemonade-server-11.9.0-fc43.aarch64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server-11.9.0-fc43.aarch64.rpm) |
| **Fedora 44 (x86_64)** | [lemonade-server-11.9.0-fc44.x86_64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server-11.9.0-fc44.x86_64.rpm) |
| **Fedora 44 (ARM64)** | [lemonade-server-11.9.0-fc44.aarch64.rpm](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-server-11.9.0-fc44.aarch64.rpm) |
| **macOS** | [Lemonade-11.9.0-Darwin.pkg](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/Lemonade-11.9.0-Darwin.pkg) |
...
| Platform | Download |
|----------|----------|
| **Ubuntu x64** | [lemonade-embeddable-11.9.0-ubuntu-x64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-embeddable-11.9.0-ubuntu-x64.tar.gz) |
| **Ubuntu arm64** | [lemonade-embeddable-11.9.0-ubuntu-arm64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-embeddable-11.9.0-ubuntu-arm64.tar.gz) |
| **Windows x64** | [lemonade-embeddable-11.9.0-windows-x64.zip](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-embeddable-11.9.0-windows-x64.zip) |
| **macOS arm64** | [lemonade-embeddable-11.9.0-macos-arm64.tar.gz](https://github.com/lemonade-sdk/lemonade/releases/download/v11.9.0/lemonade-embeddable-11.9.0-macos-arm64.tar.gz) |
...
* Update FLM version to 1.0.3 by `zaneni6` in https://github.com/lemonade-sdk/lemonade/pull/3381
* Add checkpoints to bench output by `bitgamma` in https://github.com/lemonade-sdk/lemonade/pull/3359
* feat(logging): add log rotation and transition default server posture to stdout/stderr by `abn` in https://github.com/lemonade-sdk/lemonade/pull/2864
* server: fix MTP draft companion handling by `fl0rianr` in https://github.com/lemonade-sdk/lemonade/pull/3368
* docs: fix typo maintainance -> maintenance by `vaibhav8a` in https://github.com/lemonade-sdk/lemonade/pull/3383
* fix: recover cache and models lost by 11.8.0 FHS split (#3387) by `superm1` in https://github.com/lemonade-sdk/lemonade/pull/3393
* ci(sdcpp): run the CPU validation leg only on schedule/workflow_dispatch by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3406
* test(gpu-hang): scale request timeouts to the model-operation budget by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3366
* feat(backends): hrx backend [experimental] by `AaronStGeorge` in https://github.com/lemonade-sdk/lemonade/pull/3374
* fix(routing): llm classifier no longer treats has_tools as risk by `Bekhouche` in https://github.com/lemonade-sdk/lemonade/pull/3330
* fix(test): pre-download the model in test_gpu_hang_retry before the timed load by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3408
* fix(server): classify extra models using reserved directories: chat, embeddings, reranking instead of treating all model as chat by `anditherobot` in https://github.com/lemonade-sdk/lemonade/pull/3333
* fix(server): join the directory watcher before ModelManager members die by `Geramy` in https://github.com/lemonade-sdk/lemonade/pull/3453
* Update llama.cpp to b10723 by `github-actions`[bot] in https://github.com/lemonade-sdk/lemonade/pull/3452
* Fix(#3336) improve validate llamacpp.py by `GabrielReusRodriguez` in https://github.com/lemonade-sdk/lemonade/pull/3379
* fix(ci): resolve the newest llama.cpp nightly tag instead of /releases/latest by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3450
* ci(sdcpp): raise lemond global_timeout to 3600s for validation legs by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3404
* fix(server): log unauthorized origin rejections by `abn` in https://github.com/lemonade-sdk/lemonade/pull/3418
* ci(distro): retry transient mirror and HF fetch failures by `jeremyfowers` in https://github.com/lemonade-sdk/lemonade/pull/3365
* chore: Version bump to 11.9 by `kenvandine` in https://github.com/lemonade-sdk/lemonade/pull/3454
* fix(server): allow same-origin HTTP requests matching request Host by `abn` in https://github.com/lemonade-sdk/lemonade/pull/3419
* feat(server): add allowed_origins to global configuration schema by `abn` in https://github.com/lemonade-sdk/lemonade/pull/3420

</details>

## New Contributors
* `vaibhav8a` made their first contribution in https://github.com/lemonade-sdk/lemonade/pull/3383
* `AaronStGeorge` made their first contribution in https://github.com/lemonade-sdk/lemonade/pull/3374

**Full Changelog**: https://github.com/lemonade-sdk/lemonade/compare/v11.8.1...v11.9.0
