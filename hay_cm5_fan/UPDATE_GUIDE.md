...
This addon has no upstream software to track — it IS the software. Version updates are made manually when new features or fixes are added to the addon scripts.
...
2. **Monitor**: Check addon logs after updates for any issues
