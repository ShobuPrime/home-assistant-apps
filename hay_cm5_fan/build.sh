#!/bin/bash
# Build script for HAY CM5 Fan Controller app
...
echo -e "${BLUE}=== HAY CM5 Fan Controller App Builder ===${NC}"
...
# This app only supports aarch64 (CM5 hardware)
ARCH=$(uname -m)
case $ARCH in
    aarch64)
        BUILD_ARCH="aarch64"
    ...
    *)
        ...
        echo -e "${YELLOW}This app only supports aarch64 (Raspberry Pi CM5)${NC}"
        exit 1
        ;;
esac
